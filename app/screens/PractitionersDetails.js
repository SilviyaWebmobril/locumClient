				...
				<View style={styles.container}>
					...
					<ScrollView style={{ width: '100%', flex: 1, height: '100%' }}>
						...
						<View style={{ width: '100%', height: 100, backgroundColor: '#4C74E6', alignItems: 'center', }}>
							...
							<Text style={{ fontFamily:"Roboto-Light", fontSize: 18, fontWeight: 'bold', color: "white", alignSelf: "center", }}>{this.state.name}</Text>
						...
						<View style={{ marginLeft: 10, marginTop: 40, marginBottom: 10, justifyContent: 'space-between' }}>
							...
							<Text style={{fontFamily:"Roboto-Light",  color: 'black', fontSize: 15 }}>{this.state.description}</Text>
						</View>

						<View style={{ margin: 10, justifyContent: 'space-between' }}>
							<Text style={{fontFamily:"Roboto-Light",  fontWeight: "bold" }}>Qualifications</Text>
							<Text style={{fontFamily:"Roboto-Light",  color: 'black', fontSize: 15 }}>{this.state.degree}</Text>
						</View>


						<View style={{ margin: 10, justifyContent: 'space-between' }}>
							<Text style={{fontFamily:"Roboto-Light",  fontWeight: "bold" }}>Experience</Text>
							<Text style={{fontFamily:"Roboto-Light",  color: 'black', fontSize: 15 }}>{this.state.experience}</Text>
						</View>

						<View style={{ margin: 10, justifyContent: 'space-between' }}>
							<Text style={{fontFamily:"Roboto-Light",  fontWeight: "bold" }}>Contact</Text>
							<Text style={{fontFamily:"Roboto-Light",  color: 'black', fontSize: 15 }}>{this.state.contact}</Text>
						</View>
						<View style={{ margin: 10, justifyContent: 'space-between' }}>
							<Text style={{fontFamily:"Roboto-Light",  fontWeight: "bold" }}>Email ID</Text>
							<Text style={{fontFamily:"Roboto-Light",  color: 'black', fontSize: 17 }}>{this.state.email}</Text>
						</View>
						...
						{this.state.application_status == 0
							...
							<View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
								<TouchableOpacity onPress={this.acceptPractitioner.bind(this)}
									...
									<Text style={{ fontFamily:"Roboto-Light", textAlign: 'center', fontWeight: 'bold', fontSize: 15, color: 'black', margin: 15 }}>Accept</Text>
								</TouchableOpacity>
